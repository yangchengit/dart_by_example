...
$$.ReceivePortImpl = {"": "Object;_liblib6$_id<,_liblib6$_callback<",
  ...
  ReceivePortImpl$0: function() {
    $.register$2$x($._globalState().get$currentContext(), this._liblib6$_id, this);
  },
  $isReceivePort: true
};
...
$$._ForwardingStreamSubscription = {"": "_BaseStreamSubscription;_stream,_cancelOnError,_liblib8$_subscription,_liblib8$_onData,_onError,_onDone",
  cancel$0: function() {
  ...
  _ForwardingStreamSubscription$5: function(_stream, onData, onError, onDone, _cancelOnError) {
    ...
    this._liblib8$_subscription = this._stream._liblib8$_source.listen$3$onDone$onError(t1, this.get$_handleDone(), t2);
  }
};
...
$$._WrappedList = {"": "Object;_liblib3$_list",
  get$iterator: function(_) {
    return $._WrappedIterator$($.get$iterator$ax(this._liblib3$_list));
  },
  map$1: function(_, f) {
    return $.map$1$ax(this._liblib3$_list, f);
  },
  where$1: function(_, f) {
    return $.where$1$ax(this._liblib3$_list, f);
  },
  forEach$1: function(_, f) {
    $.forEach$1$ax(this._liblib3$_list, f);
  },
  toList$1$growable: function(_, growable) {
    return $.List_List$from(this._liblib3$_list, growable, null);
  },
  toList$0: function($receiver) {
    return this.toList$1$growable($receiver, true);
  },
  get$length: function(_) {
    return $.get$length$asx(this._liblib3$_list);
  },
  get$isEmpty: function(_) {
    return $.get$isEmpty$asx(this._liblib3$_list);
  },
  skip$1: function(_, n) {
    return $.skip$1$ax(this._liblib3$_list, n);
  },
  elementAt$1: function(_, index) {
    return $.elementAt$1$ax(this._liblib3$_list, index);
  },
  add$1: function(_, element) {
    $.add$1$ax(this._liblib3$_list, element);
  },
  addAll$1: function(_, elements) {
    $.addAll$1$ax(this._liblib3$_list, elements);
  },
  remove$1: function(_, element) {
  ...
  $index: function(_, index) {
    return $.$index$asx(this._liblib3$_list, index);
  },
  $indexSet: function(_, index, value) {
    $.$indexSet$ax(this._liblib3$_list, index, value);
  },
  set$length: function(_, newLength) {
  ...
  sublist$2: function(_, start, end) {
    return $.sublist$2$ax(this._liblib3$_list, start, end);
  },
  sublist$1: function($receiver, start) {
    return this.sublist$2($receiver, start, null);
  },
...
$$.selectedColors_anon = {"": "Closure;",
  call$1: function(c) {
    return $.$index$asx($.get$colors(), c);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon = {"": "Closure;",
  call$0: function() {
    return $.get$colors().get$keys();
  },
  $isFunction: true
};

$$.init_autogenerated_anon0 = {"": "Closure;__html0_1,__html1_2",
  call$3: function($$list, $$index, __t) {
    var t1, key, __binding1;
    t1 = {};
    key = $.$index$asx($$list, $$index);
    t1.__e0_0 = null;
    t1.__e0_0 = $.clone$1$x(this.__html1_2, true);
    __t.listen$2($.get$onChange$x(t1.__e0_0), new $.init_autogenerated__anon1(t1, key));
    __t.oneWayBind$4(new $.init_autogenerated__anon2(key), new $.init_autogenerated__anon3(t1), false, false);
    __binding1 = __t.contentBind$2(new $.init_autogenerated__anon4(key), false);
    $.addAll$1$ax(__t, [document.createTextNode("\n      "), t1.__e0_0, __binding1, this.__html0_1.cloneNode(true), document.createTextNode("\n    ")]);
  },
  $isFunction: true
};

$$.init_autogenerated__anon1 = {"": "Closure;box_0,key_3",
  call$1: function($$event) {
    $.$indexSet$ax($.get$colors(), this.key_3, $.get$checked$x(this.box_0.__e0_0));
  },
  $isFunction: true
};

$$.init_autogenerated__anon2 = {"": "Closure;key_4",
  call$0: function() {
    return $.$index$asx($.get$colors(), this.key_4);
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon3 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$checked$x(t1.__e0_0), e) !== true)
      $.set$checked$x(t1.__e0_0, e);
  },
  $isFunction: true
};

$$.init_autogenerated__anon4 = {"": "Closure;key_5",
  call$0: function() {
    return this.key_5;
  },
  $isFunction: true
...
$$.init_autogenerated_anon1 = {"": "Closure;",
  call$0: function() {
    return $.get$isEmpty$asx($.selectedColors()) !== true;
  },
  $isFunction: true
};

$$.init_autogenerated_anon2 = {"": "Closure;__html2_6,__html3_7,__html4_8",
  call$1: function(__t) {
    var __e6, t1, t2;
    __e6 = $.clone$1$x(this.__html3_7, true);
    t1 = $.get$nodes$x(__e6);
    t2 = $.getInterceptor$x(__t);
    t2.loop$3(__t, t1.$index(t1, 1), new $.init_autogenerated__anon(), new $.init_autogenerated__anon0(this.__html4_8));
    t2.addAll$1(__t, [document.createTextNode("\n      "), this.__html2_6.cloneNode(true), document.createTextNode("\n      You picked:\n      "), __e6, document.createTextNode("\n    ")]);
  },
  $isFunction: true
};
...
$$.init_autogenerated__anon0 = {"": "Closure;__html4_9",
  call$3: function($$list, $$index, __t) {
    var color, __e4, __binding3, t1;
    color = $.$index$asx($$list, $$index);
    __e4 = $.clone$1$x(this.__html4_9, true);
    __binding3 = __t.contentBind$2(new $.init_autogenerated___anon(color), false);
    t1 = $.get$nodes$x(__e4);
    t1.add$1(t1, __binding3);
    $.add$1$ax(__t, __e4);
  },
  $isFunction: true
};

$$.init_autogenerated___anon = {"": "Closure;color_10",
  call$0: function() {
...
$$.ObservableMap = {"": "Observable;_liblib5$_map,_liblib5$_keys,_values,$$_observers,$$_changes,hashCode",
  get$keys: function() {
    return this._liblib5$_keys;
  },
  get$values: function(_) {
    return this._values;
  },
  ...
  $index: function(_, key) {
    ...
    return $.$index$asx(this._liblib5$_map, key);
  },
  $indexSet: function(_, key, value) {
  ...
  forEach$1: function(_, f) {
    ...
    if (t1 != null) {
      ...
      t1 = this._liblib5$_map.get$keys();
      t1.forEach$1(t1, this.get$_notifyReadKey());
    }
    $.forEach$1$ax(this._liblib5$_map, f);
  },
  toString$0: function(_) {
    var result = $.StringBuffer$("");
    $.ToString__emitPair(this, result, $.List_List($, null));
  ...
  ObservableMap$1$createMap: function(createMap, K, V) {
    this._liblib5$_keys = $._ObservableMapKeyIterable$(this, K, V);
...
$$._ObservableMapKeyIterable = {"": "IterableBase;_liblib5$_map",
  get$iterator: function(_) {
    return $._ObservableMapKeyIterator$(this._liblib5$_map);
  },
...
$$._ObservableMapKeyIterator = {"": "Object;_liblib5$_map,_liblib5$_keys,_hasNext",
  moveNext$0: function() {
    var t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this._liblib5$_map, 1, "length");
    t1 = this._liblib5$_keys.moveNext$0();
    this._hasNext = t1;
    return t1;
  },
  get$current: function() {
    var key = this._liblib5$_keys.get$current();
    if ($.observeReads() === true && this._hasNext === true)
      this._liblib5$_map._notifyReadKey$1(key);
    return key;
  }
};

$$._ObservableMapValueIterable = {"": "IterableBase;_liblib5$_map",
  get$iterator: function(_) {
    return $._ObservableMapValueIterator$(this._liblib5$_map);
  },
  $asIterableBase: function (K, V) { return [V]; },
  $asIterable: function() {
    return function (K, V) { return [V]; };
...
$$._ObservableMapValueIterator = {"": "Object;_liblib5$_map,_liblib5$_keys,_values,_hasNext",
  moveNext$0: function() {
    var t1, moreKeys, moreValues;
    t1 = $._activeObserver;
    if (t1 != null)
      t1._addRead$3(this._liblib5$_map, 1, "length");
    moreKeys = this._liblib5$_keys.moveNext$0();
  ...
  get$current: function() {
    if ($.observeReads() === true && this._hasNext === true)
      this._liblib5$_map._notifyReadKey$1(this._liblib5$_keys.get$current());
...
$$.TableCellElement = {"": "Element;",
  $isTableCellElement: function() {
    return true;
  },
  $asTableCellElement: function() {
    return null;
  }
};
...
$$.TableRowElement = {"": "Element;",
  ...
  $isTableRowElement: function() {
    return true;
  },
  $asTableRowElement: function() {
    return null;
  }
};
...
$.selectedColors = function() {
  var t1 = $.get$colors().get$keys();
  t1 = t1.where$1(t1, new $.selectedColors_anon());
  return t1.toList$0(t1);
};

$.init_autogenerated = function() {
  var _root, __html0, __html1, __html2, __html3, __html4, __t, t1, t2;
  _root = document.body;
  __html0 = document.createElement("br");
  __html1 = $._ElementFactoryProvider_createElement_html("<input type=\"checkbox\">");
  __html2 = document.createElement("br");
  __html3 = $._ElementFactoryProvider_createElement_html("<ul>\n        <li style=\"display:none\"></li>\n      </ul>");
  __html4 = $._ElementFactoryProvider_createElement_html("<li template=\"\" repeat=\"color in selectedColors\"></li>");
  __t = $.Template$(_root);
  t1 = $.getInterceptor$x(_root);
  t2 = t1.get$nodes(_root);
  __t.loop$3(__t, t2.$index(t2, 3), new $.init_autogenerated_anon(), new $.init_autogenerated_anon0(__html0, __html1));
  t1 = t1.get$nodes(_root);
  __t.conditional$3(t1.$index(t1, 5), new $.init_autogenerated_anon1(), new $.init_autogenerated_anon2(__html2, __html3, __html4));
  __t.create$0();
  __t.insert$0(__t);
};
...
$.ObservableMap_ObservableMap$from = function(other, createMap, K, V) {
  ...
  other.forEach$1(other, new $.ObservableMap_ObservableMap$from_anon(result));
  return result;
};
...
$._ObservableMapKeyIterator$ = function(map) {
  var t1 = map._liblib5$_map.get$keys();
...
$.toObservable = function(value) {
  var createMap = new $.toObservable_anon();
...
Isolate.$lazy($, "colors", "colors", "get$colors", function() {
  return $.toObservable($.makeLiteralMap(["red", false, "blue", false, "green", false]));
});
