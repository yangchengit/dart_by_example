...
$$.init_autogenerated_anon = {"": "Closure;box_0",
  call$1: function($$event) {
    $.someBool = $.get$checked$x(this.box_0.__e0_0);
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon2 = {"": "Closure;",
  call$0: function() {
    return $.someBool === true ? "checked" : "unchecked";
  },
  $isFunction: true
};
...
$.init_autogenerated = function() {
  var t1, _root, __t, t2, t3, __e2, __binding1;
  t1 = {};
  _root = document.body;
  t1.__e0_0 = null;
  __t = $.Template$(_root);
  ...
  t1.__e0_0 = t3.$index(t3, 1);
  __t.listen$2($.get$onChange$x(t1.__e0_0), new $.init_autogenerated_anon(t1));
  __t.oneWayBind$4(new $.init_autogenerated_anon0(), new $.init_autogenerated_anon1(t1), false, false);
  t2 = t2.get$nodes(_root);
  __e2 = t2.$index(t2, 5);
  __binding1 = __t.contentBind$2(new $.init_autogenerated_anon2(), false);
  $.addAll$1$ax($.get$nodes$x(__e2), [document.createTextNode("The checkbox is "), __binding1]);
  __t.create$0();
  __t.insert$0(__t);
};
