...
$$.init_autogenerated_anon0 = {"": "Closure;",
  call$0: function() {
    if ($.observeReads() === true)
      $.notifyRead($.get$__changes(), 1, "veg");
    return $.$eq($.__$veg, "kale");
  },
  $isFunction: true
};
...
$$.init_autogenerated_anon4 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$checked$x(t1.__e1_1), e) !== true)
...
$$.init_autogenerated_anon7 = {"": "Closure;box_0",
  call$1: function(e) {
    var t1 = this.box_0;
    if ($.$eq($.get$checked$x(t1.__e2_2), e) !== true)
      $.set$checked$x(t1.__e2_2, e);
  },
  $isFunction: true
};
...
$$.ChangeRecord = {"": "Object;type>,key>,oldValue,newValue>",
  $eq: function(_, other) {
    ...
    if (typeof other === "object" && other !== null && !!$.getInterceptor(other).$isChangeRecord)
      t1 = this.type === other.type && this.key === other.key && this.oldValue === other.oldValue && this.newValue === other.newValue;
    else
      t1 = false;
    return t1;
  },
  ...
  toString$0: function(_) {
    ...
    return "#<ChangeRecord " + $.S(typeStr) + " " + this.key + " from " + this.oldValue + " to " + this.newValue + ">";
  },
  $isChangeRecord: true
};
...
$.veg = function(value) {
  if ($.hasObservers($.get$__changes()))
    $.notifyChange($.get$__changes(), 1, "veg", $.__$veg, value);
  $.__$veg = value;
};

$.init_autogenerated = function() {
  var t1, _root, __t, t2, t3, __e4, __binding3;
  t1 = {};
  _root = document.body;
  t1.__e0_0 = null;
  t1.__e1_1 = null;
  ...
  t1.__e0_0 = $.$index$asx($.get$nodes$x(t3.$index(t3, 1)), 1);
  __t.listen$2($.get$onChange$x(t1.__e0_0), new $.init_autogenerated_anon());
  __t.oneWayBind$4(new $.init_autogenerated_anon0(), new $.init_autogenerated_anon1(t1), false, false);
  t3 = t2.get$nodes(_root);
  t1.__e1_1 = $.$index$asx($.get$nodes$x(t3.$index(t3, 1)), 5);
  __t.listen$2($.get$onChange$x(t1.__e1_1), new $.init_autogenerated_anon2());
  __t.oneWayBind$4(new $.init_autogenerated_anon3(), new $.init_autogenerated_anon4(t1), false, false);
  t3 = t2.get$nodes(_root);
  t1.__e2_2 = $.$index$asx($.get$nodes$x(t3.$index(t3, 1)), 9);
  __t.listen$2($.get$onChange$x(t1.__e2_2), new $.init_autogenerated_anon5());
  __t.oneWayBind$4(new $.init_autogenerated_anon6(), new $.init_autogenerated_anon7(t1), false, false);
  t2 = t2.get$nodes(_root);
  __e4 = t2.$index(t2, 3);
  __binding3 = __t.contentBind$2(new $.init_autogenerated_anon8(), false);
  $.addAll$1$ax($.get$nodes$x(__e4), [document.createTextNode("veg = "), __binding3]);
  __t.create$0();
  __t.insert$0(__t);
};
...
$.hash4 = function(w, x, y, z) {
  ...
  t3 = $.JSString_methods.get$hashCode(y);
